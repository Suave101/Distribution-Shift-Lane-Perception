...
#SBATCH --job-name=P2CULaneTrain2CULaneTest10ImageNet
#SBATCH --nodes=1
#SBATCH --ntasks=1
#SBATCH --output="/home1/adoyle2025/Distribution-Shift-Lane-Perception/LocalBash/ModelExperiments/Phase 2/ImageNetModel/10/P2CULaneTrain2CULaneTest10ImageNet.log"
...
python model_experimentP2.py \
    ...
    --file_name "P2CULaneTrain2CULaneTest10ImageNet.json" \
    --modelStr "ImageNet"
