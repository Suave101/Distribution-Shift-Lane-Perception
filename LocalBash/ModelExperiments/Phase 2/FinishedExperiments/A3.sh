...
#SBATCH --job-name=A3MMDAgg
#SBATCH --nodes=1
#SBATCH --ntasks=1
#SBATCH --output="/home1/adoyle2025/Distribution-Shift-Lane-Perception/LocalBash/MMDAgg/P2CULaneTrain2CurvelanesValid100ImageNet.log"
