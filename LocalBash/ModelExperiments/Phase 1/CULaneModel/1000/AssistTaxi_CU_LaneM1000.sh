...
#SBATCH --job-name=1000Samples_CU_LaneModel_AssistTaxiData
#SBATCH --nodes=1
#SBATCH --ntasks=1
#SBATCH --output=1000Samples_CU_LaneModel_AssistTaxiData.log
...
echo "Experiment: 1000Samples_CU_LaneModel_AssistTaxiData"
echo "----------------------------------------------------"
...
echo "Starting CU_Lane Model -> AssistTaxi Data Test..."
...
python model_experiment.py \
    ...
    --batch_size 4096 \
    --modelStr "CU_Lane" \
    --file_name "1000Samples_CU_LaneModel_AssistTaxiData.json"
