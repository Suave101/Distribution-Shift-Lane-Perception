...
#SBATCH --job-name=1000Samples_CU_LaneModel_CurvelanesData
#SBATCH --nodes=1
#SBATCH --ntasks=1
#SBATCH --output=1000Samples_CU_LaneModel_CurvelanesData.log
...
echo "Experiment: 1000Samples_CU_LaneModel_CurvelanesData"
echo "----------------------------------------------------"
...
echo "Starting CU_Lane Model -> Curvelanes Data Test..."
...
python model_experiment.py \
    ...
    --batch_size 4096 \
    --modelStr "CU_Lane" \
    --file_name "1000Samples_CU_LaneModel_CurvelanesData.json"
