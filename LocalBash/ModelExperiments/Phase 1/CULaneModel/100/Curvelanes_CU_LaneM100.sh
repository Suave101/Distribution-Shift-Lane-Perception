...
#SBATCH --job-name=100Samples_CU_LaneModel_CurvelanesData
#SBATCH --nodes=1
#SBATCH --ntasks=1
#SBATCH --output=100Samples_CU_LaneModel_CurvelanesData.log
...
echo "Experiment: 100Samples_CU_LaneModel_CurvelanesData"
echo "----------------------------------------------------"
...
python model_experiment.py \
    ...
    --batch_size 4096 \
    --modelStr "CU_Lane" \
    --file_name "100Samples_CU_LaneModel_CurvelanesData.json"
