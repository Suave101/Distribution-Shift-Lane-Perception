...
#SBATCH --job-name=1000Samples_RandomModel_AssistTaxiData
#SBATCH --nodes=1
#SBATCH --ntasks=1
#SBATCH --output=1000Samples_RandomModel_AssistTaxiData.log
...
echo "Experiment: 1000Samples_RandomModel_AssistTaxiData"
echo "----------------------------------------------------"
...
echo "Starting Random Model -> AssistTaxi Data Test..."
...
python model_experiment.py \
    ...
    --batch_size 4096 \
    --modelStr "Random" \
    --file_name "1000Samples_RandomModel_AssistTaxiData.json"
