...
#SBATCH --job-name=1000Samples_RandomModel_CurvelanesData
#SBATCH --nodes=1
#SBATCH --ntasks=1
#SBATCH --output=1000Samples_RandomModel_CurvelanesData.log
...
echo "Experiment: 1000Samples_RandomModel_CurvelanesData"
echo "----------------------------------------------------"
...
echo "Starting Random Model -> Curvelanes Data Test..."
...
python model_experiment.py \
    ...
    --batch_size 4096 \
    --modelStr "Random" \
    --file_name "1000Samples_RandomModel_CurvelanesData.json"
