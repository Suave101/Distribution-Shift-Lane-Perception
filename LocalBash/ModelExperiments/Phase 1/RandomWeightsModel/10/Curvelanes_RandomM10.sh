...
#SBATCH --job-name=10Samples_RandomModel_CurvelanesData
#SBATCH --nodes=1
#SBATCH --ntasks=1
#SBATCH --output=10Samples_RandomModel_CurvelanesData.log
...
echo "Experiment: 10Samples_RandomModel_CurvelanesData"
echo "----------------------------------------------------"
...
python model_experiment.py \
    ...
    --batch_size 4096 \
    --modelStr "Random" \
    --file_name "10Samples_RandomModel_CurvelanesData.json"
