...
#SBATCH --job-name=100Samples_RandomModel_CULanes2AssistTaxiData
#SBATCH --nodes=1
#SBATCH --ntasks=1
#SBATCH --output=100Samples_RandomModel_CULanes2AssistTaxiData.log
...
echo "Experiment: 100Samples_RandomModel_CULanes2AssistTaxiData"
echo "----------------------------------------------------"
...
python model_experiment.py \
    ...
    --batch_size 64 \
    --modelStr "Random" \
    --file_name "100Samples_RandomModel_CULanes2AssistTaxiData.json"
