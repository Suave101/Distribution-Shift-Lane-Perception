...
#SBATCH --job-name=100Samples_RandomModel_CULanesData
#SBATCH --nodes=1
#SBATCH --ntasks=1
#SBATCH --output=100Samples_RandomModel_CULanesData.log
...
echo "Experiment: 100Samples_RandomModel_CULanesData"
echo "----------------------------------------------------"
...
python model_experiment.py \
    ...
    --batch_size 4096 \
    --modelStr "Random" \
    --file_name "100Samples_RandomModel_CULanesData.json"
