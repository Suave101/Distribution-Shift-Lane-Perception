...
#SBATCH --job-name=100Samples_ImageNetModel_AssistTaxiData
#SBATCH --nodes=1
#SBATCH --ntasks=1
#SBATCH --output=100Samples_ImageNetModel_AssistTaxiData.log
...
echo "Experiment: 100Samples_ImageNetModel_AssistTaxiData"
echo "----------------------------------------------------"
...
python model_experiment.py \
    ...
    --batch_size 4096 \
    --modelStr "ImageNet" \
    --file_name "100Samples_ImageNetModel_AssistTaxiData.json"
