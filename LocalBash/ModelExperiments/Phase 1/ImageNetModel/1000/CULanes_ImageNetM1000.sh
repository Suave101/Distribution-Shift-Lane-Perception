...
#SBATCH --job-name=1000Samples_ImageNetModel_CULanesData
#SBATCH --nodes=1
#SBATCH --ntasks=1
#SBATCH --output=1000Samples_ImageNetModel_CULanesData.log
...
echo "Experiment: 1000Samples_ImageNetModel_CULanesData"
echo "----------------------------------------------------"
...
echo "Starting ImageNet Model -> CULanes Data Test..."
...
python model_experiment.py \
    ...
    --batch_size 4096 \
    --modelStr "ImageNet" \
    --file_name "1000Samples_ImageNetModel_CULanesData.json"
