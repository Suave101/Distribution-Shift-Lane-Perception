...
#SBATCH --job-name=10Samples_ImageNetModel_CULanesData
#SBATCH --nodes=1
#SBATCH --ntasks=1
#SBATCH --output=10Samples_ImageNetModel_CULanesData.log
...
echo "Experiment: 10Samples_ImageNetModel_CULanesData"
echo "----------------------------------------------------"
...
python model_experiment.py \
    ...
    --batch_size 4096 \
    --modelStr "ImageNet" \
    --file_name "10Samples_ImageNetModel_CULanesData.json"
