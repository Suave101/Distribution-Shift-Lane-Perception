...
#SBATCH --job-name=100Samples_CurveLanesModel_CULanesData
#SBATCH --nodes=1
#SBATCH --ntasks=1
#SBATCH --output=100Samples_CurveLanesModel_CULanesData.log
...
echo "Experiment: 100Samples_CurveLanesModel_CULanesData"
echo "----------------------------------------------------"
...
python model_experiment.py \
    ...
    --batch_size 4096 \
    --modelStr "CurveLanes" \
    --file_name "100Samples_CurveLanesModel_CULanesData.json"
