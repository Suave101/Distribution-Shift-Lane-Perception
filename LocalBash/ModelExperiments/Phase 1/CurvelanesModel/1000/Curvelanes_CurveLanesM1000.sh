...
#SBATCH --job-name=1000Samples_CurveLanesModel_CurvelanesData
#SBATCH --nodes=1
#SBATCH --ntasks=1
#SBATCH --output=1000Samples_CurveLanesModel_CurvelanesData.log
...
echo "Experiment: 1000Samples_CurveLanesModel_CurvelanesData"
echo "----------------------------------------------------"
...
echo "Starting CurveLanes Model -> Curvelanes Data Test..."
...
python model_experiment.py \
    ...
    --batch_size 4096 \
    --modelStr "CurveLanes" \
    --file_name "1000Samples_CurveLanesModel_CurvelanesData.json"
