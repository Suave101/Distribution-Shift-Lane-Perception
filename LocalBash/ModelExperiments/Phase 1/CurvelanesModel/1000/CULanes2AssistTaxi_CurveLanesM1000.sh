...
#SBATCH --job-name=1000Samples_CurveLanesModel_CULanes2AssistTaxiData
#SBATCH --nodes=1
#SBATCH --ntasks=1
#SBATCH --output=1000Samples_CurveLanesModel_CULanes2AssistTaxiData.log
...
echo "Experiment: 1000Samples_CurveLanesModel_CULanes2AssistTaxiData"
echo "----------------------------------------------------"
...
python model_experiment.py \
    ...
    --batch_size 64 \
    --modelStr "CurveLanes" \
    --file_name "1000Samples_CurveLanesModel_CULanes2AssistTaxiData.json"
