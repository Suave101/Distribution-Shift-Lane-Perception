...
#SBATCH --job-name=1000Samples_CurveLanesModel_AssistTaxi2CurvelanesData
#SBATCH --nodes=1
#SBATCH --ntasks=1
#SBATCH --output=1000Samples_CurveLanesModel_AssistTaxi2CurvelanesData.log
...
echo "Experiment: 1000Samples_CurveLanesModel_AssistTaxi2CurvelanesData"
echo "----------------------------------------------------"
...
python model_experiment.py \
    ...
    --batch_size 64 \
    --modelStr "CurveLanes" \
    --file_name "1000Samples_CurveLanesModel_AssistTaxi2CurvelanesData.json"
