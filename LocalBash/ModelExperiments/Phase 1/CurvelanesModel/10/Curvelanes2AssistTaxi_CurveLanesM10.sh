...
#SBATCH --job-name=10Samples_CurveLanesModel_Curvelanes2AssistTaxiData
#SBATCH --nodes=1
#SBATCH --ntasks=1
#SBATCH --output=10Samples_CurveLanesModel_Curvelanes2AssistTaxiData.log
...
echo "Experiment: 10Samples_CurveLanesModel_Curvelanes2AssistTaxiData"
echo "----------------------------------------------------"
...
python model_experiment.py \
    ...
    --batch_size 64 \
    --modelStr "CurveLanes" \
    --file_name "10Samples_CurveLanesModel_Curvelanes2AssistTaxiData.json"
