...
#SBATCH --job-name=10Samples_CurveLanesModel_CurvelanesData
#SBATCH --nodes=1
#SBATCH --ntasks=1
#SBATCH --output=10Samples_CurveLanesModel_CurvelanesData.log
...
echo "Experiment: 10Samples_CurveLanesModel_CurvelanesData"
echo "----------------------------------------------------"
...
python model_experiment.py \
    ...
    --batch_size 4096 \
    --modelStr "CurveLanes" \
    --file_name "10Samples_CurveLanesModel_CurvelanesData.json"
