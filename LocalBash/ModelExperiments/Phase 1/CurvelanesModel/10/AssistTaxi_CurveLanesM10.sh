...
#SBATCH --job-name=10Samples_CurveLanesModel_AssistTaxiData
#SBATCH --nodes=1
#SBATCH --ntasks=1
#SBATCH --output=10Samples_CurveLanesModel_AssistTaxiData.log
...
echo "Experiment: 10Samples_CurveLanesModel_AssistTaxiData"
echo "----------------------------------------------------"
...
python model_experiment.py \
    ...
    --batch_size 4096 \
    --modelStr "CurveLanes" \
    --file_name "10Samples_CurveLanesModel_AssistTaxiData.json"
