...
#SBATCH --job-name=10Samples_CurveLanesModel_CULanesData
#SBATCH --nodes=1
#SBATCH --ntasks=1
#SBATCH --output=10Samples_CurveLanesModel_CULanesData.log
...
echo "Experiment: 10Samples_CurveLanesModel_CULanesData"
echo "----------------------------------------------------"
...
python model_experiment.py \
    ...
    --batch_size 4096 \
    --modelStr "CurveLanes" \
    --file_name "10Samples_CurveLanesModel_CULanesData.json"
