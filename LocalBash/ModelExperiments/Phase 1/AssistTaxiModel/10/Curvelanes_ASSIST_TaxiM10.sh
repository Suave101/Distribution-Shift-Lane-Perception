...
#SBATCH --job-name=10Samples_ASSIST_TaxiModel_CurvelanesData
#SBATCH --nodes=1
#SBATCH --ntasks=1
#SBATCH --output=10Samples_ASSIST_TaxiModel_CurvelanesData.log
...
echo "Experiment: 10Samples_ASSIST_TaxiModel_CurvelanesData"
echo "----------------------------------------------------"
...
python model_experiment.py \
    ...
    --file_name "10Samples_ASSIST_TaxiModel_CurvelanesData.json"
