...
#SBATCH --job-name=10Samples_ASSIST_TaxiModel_AssistTaxiData
#SBATCH --nodes=1
#SBATCH --ntasks=1
#SBATCH --output=10Samples_ASSIST_TaxiModel_AssistTaxiData.log
...
echo "Experiment: 10Samples_ASSIST_TaxiModel_AssistTaxiData"
echo "----------------------------------------------------"
...
python model_experiment.py \
    ...
    --file_name "10Samples_ASSIST_TaxiModel_AssistTaxiData.json"
