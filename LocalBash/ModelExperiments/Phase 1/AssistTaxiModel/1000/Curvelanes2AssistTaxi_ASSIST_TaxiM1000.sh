...
#SBATCH --job-name=1000Samples_ASSIST_TaxiModel_Curvelanes2AssistTaxiData
#SBATCH --nodes=1
#SBATCH --ntasks=1
#SBATCH --output=1000Samples_ASSIST_TaxiModel_Curvelanes2AssistTaxiData.log
...
echo "Experiment: 1000Samples_ASSIST_TaxiModel_Curvelanes2AssistTaxiData"
echo "----------------------------------------------------"
...
python model_experiment.py \
    ...
    --file_name "1000Samples_ASSIST_TaxiModel_Curvelanes2AssistTaxiData.json"
