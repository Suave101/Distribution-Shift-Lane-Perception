...
#SBATCH --job-name=1000Samples_ASSIST_TaxiModel_CurvelanesData
#SBATCH --nodes=1
#SBATCH --ntasks=1
#SBATCH --output=1000Samples_ASSIST_TaxiModel_CurvelanesData.log
...
echo "Experiment: 1000Samples_ASSIST_TaxiModel_CurvelanesData"
echo "----------------------------------------------------"
...
echo "Starting ASSIST_Taxi Model -> Curvelanes Data Test..."
...
python model_experiment.py \
    ...
    --file_name "1000Samples_ASSIST_TaxiModel_CurvelanesData.json"
