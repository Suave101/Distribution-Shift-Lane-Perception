...
#SBATCH --job-name=1000Samples_ASSIST_TaxiModel_CULanesData
#SBATCH --nodes=1
#SBATCH --ntasks=1
#SBATCH --output=1000Samples_ASSIST_TaxiModel_CULanesData.log
...
echo "Experiment: 1000Samples_ASSIST_TaxiModel_CULanesData"
echo "----------------------------------------------------"
...
echo "Starting ASSIST_Taxi Model -> CULanes Data Test..."
...
python model_experiment.py \
    ...
    --file_name "1000Samples_ASSIST_TaxiModel_CULanesData.json"
