...
#SBATCH --job-name=100Samples_ASSIST_TaxiModel_CurvelanesData
#SBATCH --nodes=1
#SBATCH --ntasks=1
#SBATCH --output=100Samples_ASSIST_TaxiModel_CurvelanesData.log
...
echo "Experiment: 100Samples_ASSIST_TaxiModel_CurvelanesData"
echo "----------------------------------------------------"
...
python model_experiment.py \
    ...
    --file_name "100Samples_ASSIST_TaxiModel_CurvelanesData.json"
