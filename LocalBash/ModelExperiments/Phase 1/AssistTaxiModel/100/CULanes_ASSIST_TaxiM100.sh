...
#SBATCH --job-name=100Samples_ASSIST_TaxiModel_CULanesData
#SBATCH --nodes=1
#SBATCH --ntasks=1
#SBATCH --output=100Samples_ASSIST_TaxiModel_CULanesData.log
...
echo "Experiment: 100Samples_ASSIST_TaxiModel_CULanesData"
echo "----------------------------------------------------"
...
python model_experiment.py \
    ...
    --file_name "100Samples_ASSIST_TaxiModel_CULanesData.json"
