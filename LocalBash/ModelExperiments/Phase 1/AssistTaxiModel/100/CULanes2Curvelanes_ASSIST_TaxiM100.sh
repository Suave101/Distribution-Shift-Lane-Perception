...
#SBATCH --job-name=100Samples_ASSIST_TaxiModel_CULanes2CurvelanesData
#SBATCH --nodes=1
#SBATCH --ntasks=1
#SBATCH --output=100Samples_ASSIST_TaxiModel_CULanes2CurvelanesData.log
...
echo "Experiment: 100Samples_ASSIST_TaxiModel_CULanes2CurvelanesData"
echo "----------------------------------------------------"
...
python model_experiment.py \
    ...
    --file_name "100Samples_ASSIST_TaxiModel_CULanes2CurvelanesData.json"
