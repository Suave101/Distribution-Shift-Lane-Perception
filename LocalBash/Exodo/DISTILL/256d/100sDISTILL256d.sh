...
#SBATCH --job-name=100sDISTILL256d
#SBATCH --nodes=1
#SBATCH --ntasks=1
#SBATCH --output="/home1/adoyle2025/Distribution-Shift-Lane-Perception/LocalBash/Exodo/DISTILL/256d/100sDISTILL256d.log"
...
python model_experiment.py \
    ...
    --file_name "100sDISTILL256d.json" \
    --modelStr "DISTILL"
