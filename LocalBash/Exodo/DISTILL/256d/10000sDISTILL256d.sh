...
#SBATCH --job-name=10000sDISTILL256d
#SBATCH --nodes=1
#SBATCH --ntasks=1
#SBATCH --output="/home1/adoyle2025/Distribution-Shift-Lane-Perception/LocalBash/Exodo/DISTILL/256d/10000sDISTILL256d.log"
...
python model_experiment.py \
    ...
    --file_name "10000sDISTILL256d.json" \
    --modelStr "DISTILL"
