...
#SBATCH --job-name=100sDISTILL32d
#SBATCH --nodes=1
#SBATCH --ntasks=1
#SBATCH --output="/home1/adoyle2025/Distribution-Shift-Lane-Perception/LocalBash/Exodo/DISTILL/32d/100sDISTILL32d.log"
