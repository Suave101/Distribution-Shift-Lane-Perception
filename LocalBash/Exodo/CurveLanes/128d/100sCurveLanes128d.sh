...
#SBATCH --job-name=100sCurveLanes128d
#SBATCH --nodes=1
#SBATCH --ntasks=1
#SBATCH --output="/home1/adoyle2025/Distribution-Shift-Lane-Perception/LocalBash/Exodo/CurveLanes/128d/100sCurveLanes128d.log"
...
python model_experiment.py \
    ...
    --file_name "100sCurveLanes128d.json" \
    --modelStr "CurveLanes"
