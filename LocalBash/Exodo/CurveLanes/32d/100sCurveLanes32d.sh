...
#SBATCH --job-name=100sCurveLanes32d
#SBATCH --nodes=1
#SBATCH --ntasks=1
#SBATCH --output="/home1/adoyle2025/Distribution-Shift-Lane-Perception/LocalBash/Exodo/CurveLanes/32d/100sCurveLanes32d.log"
...
python model_experiment.py \
    ...
    --file_name "100sCurveLanes32d.json" \
    --modelStr "CurveLanes"
