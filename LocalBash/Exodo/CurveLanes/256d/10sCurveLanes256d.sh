...
#SBATCH --job-name=10sCurveLanes256d
#SBATCH --nodes=1
#SBATCH --ntasks=1
#SBATCH --output="/home1/adoyle2025/Distribution-Shift-Lane-Perception/LocalBash/Exodo/CurveLanes/256d/10sCurveLanes256d.log"
...
python model_experiment.py \
    ...
    --file_name "10sCurveLanes256d.json" \
    --modelStr "CurveLanes"
