...
#SBATCH --job-name=1000sRandom256d
#SBATCH --nodes=1
#SBATCH --ntasks=1
#SBATCH --output="/home1/adoyle2025/Distribution-Shift-Lane-Perception/LocalBash/Exodo/Random/256d/1000sRandom256d.log"
...
python model_experiment.py \
    ...
    --file_name "1000sRandom256d.json" \
    --modelStr "Random"
