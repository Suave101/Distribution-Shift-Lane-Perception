...
#SBATCH --job-name=10000sRandom32d
#SBATCH --nodes=1
#SBATCH --ntasks=1
#SBATCH --output="/home1/adoyle2025/Distribution-Shift-Lane-Perception/LocalBash/Exodo/Random/32d/10000sRandom32d.log"
...
python model_experiment.py \
    ...
    --file_name "10000sRandom32d.json" \
    --modelStr "Random"
