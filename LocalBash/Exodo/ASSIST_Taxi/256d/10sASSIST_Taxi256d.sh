...
#SBATCH --job-name=10sASSIST_Taxi256d
#SBATCH --nodes=1
#SBATCH --ntasks=1
#SBATCH --output="/home1/adoyle2025/Distribution-Shift-Lane-Perception/LocalBash/Exodo/ASSIST_Taxi/256d/10sASSIST_Taxi256d.log"
...
python model_experiment.py \
    ...
    --file_name "10sASSIST_Taxi256d.json" \
