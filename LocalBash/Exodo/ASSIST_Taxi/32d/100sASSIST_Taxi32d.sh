...
#SBATCH --job-name=100sASSIST_Taxi32d
#SBATCH --nodes=1
#SBATCH --ntasks=1
#SBATCH --output="/home1/adoyle2025/Distribution-Shift-Lane-Perception/LocalBash/Exodo/ASSIST_Taxi/32d/100sASSIST_Taxi32d.log"
...
python model_experiment.py \
    ...
    --file_name "100sASSIST_Taxi32d.json" \
