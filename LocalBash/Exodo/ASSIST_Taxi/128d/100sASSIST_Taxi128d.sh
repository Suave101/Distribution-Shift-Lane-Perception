...
#SBATCH --job-name=100sASSIST_Taxi128d
#SBATCH --nodes=1
#SBATCH --ntasks=1
#SBATCH --output="/home1/adoyle2025/Distribution-Shift-Lane-Perception/LocalBash/Exodo/ASSIST_Taxi/128d/100sASSIST_Taxi128d.log"
...
python model_experiment.py \
    ...
    --file_name "100sASSIST_Taxi128d.json" \
