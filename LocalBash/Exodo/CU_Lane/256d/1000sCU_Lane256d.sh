...
#SBATCH --job-name=1000sCU_Lane256d
#SBATCH --nodes=1
#SBATCH --ntasks=1
#SBATCH --output="/home1/adoyle2025/Distribution-Shift-Lane-Perception/LocalBash/Exodo/CU_Lane/256d/1000sCU_Lane256d.log"
...
python model_experiment.py \
    ...
    --file_name "1000sCU_Lane256d.json" \
    --modelStr "CU_Lane"
