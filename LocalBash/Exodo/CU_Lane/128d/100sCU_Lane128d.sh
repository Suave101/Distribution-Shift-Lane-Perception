...
#SBATCH --job-name=100sCU_Lane128d
#SBATCH --nodes=1
#SBATCH --ntasks=1
#SBATCH --output="/home1/adoyle2025/Distribution-Shift-Lane-Perception/LocalBash/Exodo/CU_Lane/128d/100sCU_Lane128d.log"
...
python model_experiment.py \
    ...
    --file_name "100sCU_Lane128d.json" \
    --modelStr "CU_Lane"
