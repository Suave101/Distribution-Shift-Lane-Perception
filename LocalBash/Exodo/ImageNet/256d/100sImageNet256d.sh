...
#SBATCH --job-name=100sImageNet256d
#SBATCH --nodes=1
#SBATCH --ntasks=1
#SBATCH --output="/home1/adoyle2025/Distribution-Shift-Lane-Perception/LocalBash/Exodo/ImageNet/256d/100sImageNet256d.log"
...
python model_experiment.py \
    ...
    --file_name "100sImageNet256d.json" \
    --modelStr "ImageNet"
