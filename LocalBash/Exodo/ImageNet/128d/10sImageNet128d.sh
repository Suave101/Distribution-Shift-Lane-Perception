...
#SBATCH --job-name=10sImageNet128d
#SBATCH --nodes=1
#SBATCH --ntasks=1
#SBATCH --output="/home1/adoyle2025/Distribution-Shift-Lane-Perception/LocalBash/Exodo/ImageNet/128d/10sImageNet128d.log"
...
python model_experiment.py \
    ...
    --file_name "10sImageNet128d.json" \
    --modelStr "ImageNet"
