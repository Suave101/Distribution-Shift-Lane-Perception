...
#SBATCH --job-name=100Samples_CurveLanesModel_AssistTaxi2CULanesData
#SBATCH --nodes=1
#SBATCH --ntasks=1
#SBATCH --output=100Samples_CurveLanesModel_AssistTaxi2CULanesData.log
...
echo "Experiment: 100Samples_CurveLanesModel_AssistTaxi2CULanesData"
echo "----------------------------------------------------"
...
python model_experiment.py \
    ...
    --batch_size 64 \
    --modelStr "CurveLanes" \
    --file_name "100Samples_CurveLanesModel_AssistTaxi2CULanesData.json"
