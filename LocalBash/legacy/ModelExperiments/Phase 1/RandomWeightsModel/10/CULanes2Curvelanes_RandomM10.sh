...
#SBATCH --job-name=10Samples_RandomModel_CULanes2CurvelanesData
#SBATCH --nodes=1
#SBATCH --ntasks=1
#SBATCH --output=10Samples_RandomModel_CULanes2CurvelanesData.log
...
echo "Experiment: 10Samples_RandomModel_CULanes2CurvelanesData"
echo "----------------------------------------------------"
...
python model_experiment.py \
    ...
    --batch_size 64 \
    --modelStr "Random" \
    --file_name "10Samples_RandomModel_CULanes2CurvelanesData.json"
