...
#SBATCH --job-name=1000Samples_CU_LaneModel_CULanes2CurvelanesData
#SBATCH --nodes=1
#SBATCH --ntasks=1
#SBATCH --output=1000Samples_CU_LaneModel_CULanes2CurvelanesData.log
...
echo "Experiment: 1000Samples_CU_LaneModel_CULanes2CurvelanesData"
echo "----------------------------------------------------"
...
python model_experiment.py \
    ...
    --batch_size 64 \
    --modelStr "CU_Lane" \
    --file_name "1000Samples_CU_LaneModel_CULanes2CurvelanesData.json"
