...
def train(args):
    ...
    model = ConfP2ConvAutoencoderFC(latent_dim=256).to(device)
    ...
    checkpoint_files = glob.glob(
        f"{save_dir}/256P2autoencoder_{args.dataset_name}_epoch_*.pth"
    )
    ...
    for epoch in range(start_epoch, args.epochs):
        ...
        torch.save(
            ...
            f"{save_dir}/256P2autoencoder_{args.dataset_name}_epoch_{epoch+1}.pth",
        )
