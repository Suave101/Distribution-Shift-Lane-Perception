...
from models.autoencoderConfigurable2 import Conf2ConvAutoencoderFC
...
def train(args):
    ...
    checkpoint_files = glob.glob(
        f"{save_dir}/autoencoder_{args.dataset_name}_epoch_*.pth"
    )
    ...
    for epoch in range(start_epoch, args.epochs):
        ...
        torch.save(
            ...
            f"{save_dir}/autoencoder_{args.dataset_name}_epoch_{epoch+1}.pth",
        )
